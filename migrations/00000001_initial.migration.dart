...
class Migration1 extends Migration { 
  ...
  Future upgrade() async {
		...
		database.addColumn("_Message", SchemaColumn.relationship("from", ManagedPropertyType.string, relatedTableName: "_Chatter", relatedColumnName: "id", rule: DeleteRule.nullify, isNullable: true, isUnique: false));
		database.addColumn("_Message", SchemaColumn.relationship("to", ManagedPropertyType.string, relatedTableName: "_Chatter", relatedColumnName: "id", rule: DeleteRule.nullify, isNullable: true, isUnique: false));
